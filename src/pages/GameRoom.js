...
export default function GameRoom() {
    ...
    const iaPlays = () => {
        if (iaCards.length === 0 || gamePhase !== 'playing')
            return;
    ...
    return (_jsxs("div", { className: "mobile-container", children: [_jsx("div", { className: "game-header", children: _jsxs("button", { onClick: resetGame, className: "btn btn-primary btn-menu", children: [_jsx("i", { className: "fa fa-refresh" }), " Reset S\u00E9rie"] }) }), _jsx(GameBoard, { playerCards: playerCards, opponentCards: iaCards, tableCard: tableCard, opponentTableCard: opponentTableCard, message: message, onPlay: playCard, disabled: turn !== 'player' || gamePhase !== 'playing' }), _jsx("div", { className: "game-reward text-center my-2", children: "\uD83C\uDF81 Gain potentiel : Ta dignit\u00E9" }), _jsxs("div", { className: "game-footer mt-2", children: ["Manches : \uD83E\uDDCD ", score.player, " - \uD83E\uDD16 ", score.ia, " | Parties : \uD83C\uDFAF ", games.player, " - ", games.ia, gamePhase === 'gameEnd' && (_jsx("div", { className: "mt-2", children: _jsx("button", { onClick: resetGame, className: "btn btn-success", children: "Nouvelle S\u00E9rie" }) }))] })] }));
}
