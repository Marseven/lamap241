...
export default function GameRoom() {
    ...
    if (gameMode === 'multiplayer' && loading && gameState.gamePhase !== 'waiting' && !error) {
        return (_jsx("div", { className: "min-h-screen bg-black text-white flex items-center justify-center", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "loading-spinner mb-4" }), _jsx("p", { children: "Chargement de la partie..." })] }) }));
    }
